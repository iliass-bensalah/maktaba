<!-- Form to return a bookitem, it requires admin rights because of the assumption
 that the returning operation is either done by a worker with admin rights,
 or by the user at a terminal with admin rights -->
...
<title>Open Library - return</title>
