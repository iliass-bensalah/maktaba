<!-- For a normal user: shows the item menu,
 where they can see what items they are currently borrowing 
 	For an admin: shows Borrow, Return and Manage additionally to the item menu,
 	 -->
