<!-- Form to borrow a book for a user, under the assumption
that the borrowing is either done by a library worker who have
admin privileges, or by users at terminals who also have admin
privileges -->
...
<%
	/*
	* Needs a useremail and a bookitem_id. Does the borrowing operation.
	* Checks if the useremail and the bookitem_id are valid,
	* then checks if the bookitem is available for consistency,
	* then checks if the user has admin rights.
	* 
	*/
